...
// ─── Connections (silent-failure surface) ───────────────────────
//
// Singleflight + 3s TTL cached snapshot of 10 subsystem probes plus
// the last ~50 degradation events. Never returns 5xx — individual
// tiles go status:"unknown" on probe error, rollup ignores them.
